...
function id_tax () {
    cat $1 \
    | awk -F"\t" 'NR>1{ if ($9 !="") print $1 "\t" $9 ; \
    else if ($9=="" && $8 !="") print $1 "\t" $8 ; \
    else if ($9=="" && $8=="" && $7 !="") print $1 "\t" $7 ; \
    else if ($9=="" && $8=="" && $7 =="" && $6 !="") print $1 "\t" $6 ; \
    else if ($9=="" && $8=="" && $7 =="" && $6 =="" && $5 !="" ) print $1 "\t" $5 ; \
    else if ($9=="" && $8=="" && $7 =="" && $6 =="" && $5 =="" && $4 !="" ) print $1 "\t" $4 ; \
    else if ($9=="" && $8=="" && $7 =="" && $6 =="" && $5 =="" && $4 =="" && $3 !="") print $1 "\t" $3 ; \
